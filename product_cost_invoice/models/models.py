...
class AccountMove(models.Model):
    ...
    def update_stock_move_line(self, line):
        logger.warning("----------update_stock_move_line-----------")
...
-----------------------------------------------------------
        ...
        logger.warning(productos)
        logger.warning(line_ids)
        ...
        for line in move_lines:
            ...
            # logger.warning(valued_move_line.product_uom_id._compute_quantity(valued_move_line.qty_done, line.product_id.uom_id))
    ...
    def action_post(self):
        logger.warning("--------product_cost_invoice--------")
        """
...
class ProductTemplate(models.Model):
    ...
    def standard_price_correction(self, product_ids=None):
        ...
        line_ids = self.mapped('transfer_ids').ids
        move_lines = self.env['stock.move'].search([('picking_id','in',line_ids),('product_id','in',product_ids)])
